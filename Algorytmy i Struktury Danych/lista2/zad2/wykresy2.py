...
def generate_plots(algorithm, k_values):
    for k in k_values:
        ...
        filename = f"wyniki_{algorithm}2.txt"  # Adjusted filename
        ...
        plt.savefig(f'{algorithm}_k{k}_plots2.png')  # Updated filename

        
        plt.show()

def main():
    algorithms = ['hybridsort', 'quicksort']  # Adjusted list of algorithms
    k_values = [1, 10, 20]
